  ...
  return (
    <>
      <div className={'relative px-5 flex flex-col gap-y-4 '}>
        ...
        {/*filter*/}
        {examReviewsCRT_003Error || examReviewsCRT_004Error ? null : (
        ...
        {examReviewsCRT_003Error ? (
          <div className={'flex flex-col justify-center items-center min-h-[600px] text-h3 text-gray4'}>
            시험 정보가 곧 등록될 예정이에요.
          </div>
        ) : examReviewsCRT_004Error ? (
          <div className={'flex flex-col justify-center items-center min-h-[600px] text-h3 text-gray4'}>
            따끈후기는 시험 이후에 작성할 수 있어요.
          </div>
        ) : (
