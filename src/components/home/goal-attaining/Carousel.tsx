...
const CarouselCardView = () => {
  const [items, setItems] = useState([
    {
      id: 1,
      title: '정보처리기사 한달만에 취득',
      date: '23.10.17',
      content:
        '정보처리기사 한달만에 취득정보처리기사 한달만에 취득정보처리기사 한달만에 취득정보처리기사 한달만에 취득',
    },
    { id: 2, title: '정보처리기사 한달만에 취득', date: '23.10.17', content: 'Amet' },
    { id: 3, title: '정보처리기사 한달만에 취득', date: '23.10.17', content: 'Consecte' },
    { id: 4, title: '정보처리기사 한달만에 취득', date: '23.10.17', content: 'Lorem' },
    { id: 5, title: '정보처리기사 한달만에 취득', date: '23.10.17', content: 'Amet' },
    { id: 6, title: '정보처리기사 한달만에 취득', date: '23.10.17', content: 'Consecte' },
  ]);
      ...
      <Carousel
        ...
        {items.map((item) => (
          <div key={item.id} className="p-4">
            <div className="w-[95%] h-96 mx-auto rounded-3xl">
              <div className="h-[95%] bg-primary rounded-3xl">
                <div className="p-4">
                  <img
                  ...
                  />
                  <h2 className="flex text-h3 text-white font-bold mt-2">{item.title}</h2>
                  <h2 className="flex text-h6 text-white mb-2">{item.date}</h2>
                  <p className="flex text-h4 text-white font-semibold mt-2">{item.content}</p>
                </div>
              </div>
            </div>
          </div>
