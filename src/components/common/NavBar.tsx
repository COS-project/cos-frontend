...
export default function NavBar() {
  ...
  return (
    <nav className="fixed z-20 bottom-0 flex w-full justify-center rounded-t-[32px] items-center gap-[0.8rem] pb-[2rem] pt-[0.8rem] bg-white drop-shadow-[0_-4px_12px_rgba(0,0,0,0.08)]">
      {MENU_LIST.map((menu) => {
        return (
